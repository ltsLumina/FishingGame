...
{
	/**
	 * Converts a whole value to a percentage (decimal)
	 * @param Value The whole value to convert to a percentage (to decimal)
	 */
	...
	/**
	 * Converts a percentage (decimal) to a whole value
	 * @param Percent The percentage value (as a decimal, e.g. 0.25 for 25%)
	...
	bool RollPercentChance(float PercentChance, bool Inclusive = false)
	{
		if (Inclusive)
		{
